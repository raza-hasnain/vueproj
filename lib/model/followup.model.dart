...
FollowUpModel apiFollowUpModelFromJson(String str) =>
    FollowUpModel.fromJson(json.decode(str));

String apiFollowUpLeadsModelToJson(FollowUpModel data) =>
...
class FollowUpModel {
  ...
  factory FollowUpModel.fromJson(Map<String, dynamic> json) => FollowUpModel(
        ...
        userId: json['user_id'],
        followUpLeads: FollowUpLeads.fromJson(json["leads"]),
      );

  Map<String, dynamic> toJson() => {
        "count": count,
        "message": message,
        "leads": followUpLeads?.toJson(),
      };
}
...
class FollowUpLeads {
  ...
  factory FollowUpLeads.fromJson(Map<String, dynamic> json) {
