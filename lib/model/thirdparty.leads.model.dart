...
ThirdPartyLeadsModel apiThirdPartyLeadsModelFromJson(String str) =>
    ThirdPartyLeadsModel.fromJson(json.decode(str));

String apiThirdPartyLeadsModelToJson(ThirdPartyLeadsModel data) =>
    json.encode(data.toJson());

class ThirdPartyLeadsModel {
  ThirdPartyLeadsModel({
    required this.count,
    required this.message,
    required this.userId,
    this.thirdpartyLeads,
    this.totalClosed,
  });
  ...
  factory ThirdPartyLeadsModel.fromJson(Map<String, dynamic> json) => ThirdPartyLeadsModel(
        count: json["count"],
        message: json["message"],
        userId: json['user_id'],
        thirdpartyLeads: ThirdPartyLeads.fromJson(json["coldLeads"]),
  ...
  Map<String, dynamic> toJson() => {
        "count": count,
        "message": message,
        "thirdpartyLeads": thirdpartyLeads?.toJson(),
      };
}

class ThirdPartyLeads {
  ThirdPartyLeads({
    this.currentPage,
    this.data,
    this.firstPageUrl,
  ...
  factory ThirdPartyLeads.fromJson(Map<String, dynamic> json) {
