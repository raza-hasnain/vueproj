...
import 'package:test_project/view/sales_agent/thirdparty_leads.dart';

import '../controller/logout.controller.dart';
import '../theme/p_theme.dart';
import '../view/call.history.view.dart';
import 'package:test_project/view/sales_agent/hot_leads.dart';
import 'package:test_project/view/sales_agent/meeting_leads.dart';
import 'package:test_project/view/sales_agent/new_leads.dart';
...
class NavigationDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      backgroundColor: dark ? CustomAppTheme().colorBlack : CustomAppTheme().background,
      child: Column(
  ...
  Widget buildProfileHeader(BuildContext context) {
            ...
            ExpansionTile(
              ...
              children: [
                ...
                ListTile(
                  ...
                  trailing:
                  Text("${personalLeads.apiModel?.personalLeads?.total ?? 0}"),
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const ThirdPartyLeads()));
                  },
                ),
                // ListTile(
              ...
              Consumer<MeetingsController>(builder: (context, meeting, _) {
                return Text(
                  meeting.apiModel!.count == null
                      ? "0"
                      : meeting.apiModel!.count.toString().toString(),
                );
              }),
              onTap: () {
                Navigator.pop(context);
    ...
    Widget buildProfileFooter(BuildContext context) {
     ...
     return Container(
      ...
      child: ListTile(
        title: Image(
          image: dark ? AssetImage("assets/images/logo/hikallogo.png") : AssetImage("assets/images/logo/fullLogoRE.png"),
          height: 30,
        ),
      ),
    );
