...
class OClosedDeals extends StatefulWidget {
  const OClosedDeals({super.key});

  @override
  State<OClosedDeals> createState() => _OClosedDealsState();
}

class _OClosedDealsState extends State<OClosedDeals> {
  var lead;
  @override
  void initState() {
