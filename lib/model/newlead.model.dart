...
NewLeadModel apiNewLeadsModelFromJson(String str) =>
    NewLeadModel.fromJson(json.decode(str));

String apiNewLeadsModelToJson(NewLeadModel data) =>
...
class NewLeadModel {
  ...
  factory NewLeadModel.fromJson(Map<String, dynamic> json) => NewLeadModel(
        ...
        userId: json['user_id'],
        newLeads: NewLeads.fromJson(json["leads"]),
      );

  Map<String, dynamic> toJson() => {
        "count": count,
        "message": message,
        "leads": newLeads?.toJson(),
      };
}
